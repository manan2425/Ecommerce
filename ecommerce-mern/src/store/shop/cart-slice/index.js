...
export const addToCart = createAsyncThunk("/cart/addToCart",
    ...
    try{
        const response = await api.post(`/api/shop/cart/add`,{userId,productId,quantity,selectedPart});
...
export const updateCartQuantity = createAsyncThunk("/cart/updateCart",
    ...
    try{
        const response = await api.put(`/api/shop/cart/update-cart`,{userId,itemId,quantity});
...
export const deleteCartItem = createAsyncThunk("/cart/deleteCartItem",
    async({userId,itemId})=>{
    try{
        const response = await api.delete(`/api/shop/cart/delete-cart/${userId}/${itemId}`);
